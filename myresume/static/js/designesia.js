...
(function ($) {
    ...
    function load_magnificPopup() {
        jQuery('.simple-ajax-popup-align-top').magnificPopup({
            type: 'ajax', alignTop: true, overflowY: 'scroll'
        });
    ...
    function load_owl() {
        jQuery("#gallery-carousel").owlCarousel({
            items: 4, navigation: false, pagination: false
        });
        jQuery("#gallery-carousel-2").owlCarousel({
            items: 2, navigation: false, pagination: false
        });
        jQuery("#gallery-carousel-3").owlCarousel({
            items: 3, navigation: false, pagination: false
        });
        jQuery("#gallery-carousel-4").owlCarousel({
            items: 4, navigation: false, pagination: false
        });
        jQuery("#gallery-carousel-5").owlCarousel({
            items: 5, navigation: false, pagination: false
        });
        jQuery("#gallery-carousel-6").owlCarousel({
            items: 6, navigation: false, pagination: false
        });
        jQuery(".carousel-gallery").owlCarousel({
            items: 4, navigation: false, pagination: false
        });
        jQuery("#carousel-3,#carousel-services-3,#blog-carousel").owlCarousel({
            items: 3, navigation: false, pagination: true
        });
        jQuery("#carousel-2").owlCarousel({
            items: 2, navigation: false, pagination: true
        });
        ...
        jQuery("#logo-carousel").owlCarousel({
            items: 5, navigation: false, pagination: false, mouseDrag: false, touchDrag: false, autoPlay: true
        });
        jQuery("#contact-carousel").owlCarousel({
            items: 1, singleItem: true, navigation: false, pagination: false, autoPlay: true
        });
        ...
        jQuery(".blog-slide").owlCarousel({
            items: 1, singleItem: true, navigation: false, pagination: false, autoPlay: false
        });
    ...
    $.scrollTo = $.fn.scrollTo = function (x, y, options) {
        ...
        options = $.extend({}, {
            gap: {
                ...
                easing: 'easeInOutExpo', duration: 600, complete: $.noop, step: $.noop
            }
        }, options);
            ...
            jQuery("#loader-area .project-load").load(url, function () {
                jQuery("#loader-area").slideDown(500, function () {
                    ...
                    jQuery(".image-slider").owlCarousel({
                        items: 1, singleItem: true, navigation: false, pagination: true, autoPlay: false
                    });
