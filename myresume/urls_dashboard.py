...
urlpatterns = [
    ...
    path('social-medias/', SocialMediasCreateView.as_view(), name='socialmedias'),
    path('social-medias/edit/<int:pk>', SocialMediasUpdateView.as_view(), name='socialmedias-update'),
    path('social-medias/delete/<int:pk>', SocialMediasDeleteView.as_view(), name='socialmedias-delete'),
]
